...
class AdminReport extends Component {
    ...
    componentDidMount() {
        ...
        axios({
            ...
            .then((response) => {
                dt.push(response.data.filter((item) => item.appointmentDate.substr(3, 2) == '01' && !item.checkedIn && item.appointmentDate.localCompare(12/16/2021)).length)
                ...
                dt.push(response.data.filter((item) => item.appointmentDate.substr(3, 2) == '12' && !item.checkedIn && item.appointmentDate.localCompare("12/16/2021") < 0).length)
                console.log(dt)
                this.setState({
                    series: [
                        {
